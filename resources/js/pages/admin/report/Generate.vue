...
const validate = () => {
  ...
  if (form.period === 'custom') {
    ...
    console.log(start, end, form.start_date, form.end_date)
    // Validasi start_date
...
function updateState() {
  ...
  else if (form.report_type == 'closing-by-sales') {
    filter_options.show_period = true;
  }
          ...
          <q-card square flat bordered class="col">
            ...
            <q-card-section class="q-pt-none">
              ...
              <q-select v-model="form.report_type" label="Jenis Laporan" :options="report_types" map-options emit-value
                :error="!!form.errors.report_type" :disable="form.processing"
